...
![UI-Community](https://raw.githubusercontent.com/shreyanshtiwari4/WeNet/main/resources/UI-Community.png)
...
![Schema Diagram](https://raw.githubusercontent.com/shreyanshtiwari4/WeNet/main/resources/Schema-Diagram.png)
...
```bash
git clon https://github.com/shreyanshtiwari4/WeNet
```
...
Moderators have specific email domain (`@mod.wenet.com`). When registering with an email from this domain, the user is automatically assigned the moderator role. Moderators can be assigned to different communities from the admin dashboard.